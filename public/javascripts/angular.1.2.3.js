        ...
        $scope.$watchCollection(rhs, function ngRepeatAction(collection){
          ...
          for (index = 0, length = collectionKeys.length; index < length; index++) {
            ...
            if (nextBlockOrder[index - 1]) {
                if( nextBlockOrder[index - 1].endNode.nodeType == 8 &&
                    nextBlockOrder[index - 1].endNode.nodeValue == ' end ngRepeat: ' + expression + ' ') { // comment element
                    nextBlockOrder[index - 1].endNode = nextBlockOrder[index - 1].startNode;
                    //$animate.leave(jqLite(previousNode));
                }
              ...
              $transclude(childScope, function(clone) {
                ...
                $animate.enter(clone, null, jqLite(previousNode));
                 /* if( previousNode.nodeType == 8 &&
                      previousNode.nodeValue == ' end ngRepeat: ' + expression + ' ') { // comment element
                      $animate.leave(jqLite(previousNode));
                  }  */
                previousNode = clone;
